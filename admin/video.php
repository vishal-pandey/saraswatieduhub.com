		...
		<section class="col-sm-12 main-section">
			<section class="col-sm-8 subsection">
				<div class="col-sm-12 yle">
					<h2>Video Links</h2>
					<form action="./content/videoprocess.php" method="post">
							...
							<?php
								...
								while($row = $result->fetch_assoc())
								{
									...
									echo "<div class='form-group'>".
											"<input type='text' class='form-control' name='countt[]' value='".$row['vlink']."'></input><a href='#' class='remove_field'>Remove</a>".
										"</div>";
								}			
							?>
